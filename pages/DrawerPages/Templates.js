...
const Templates = ({ navigation }) => {
    ...
    const ModalItem = ({ DeviceSize, Username, index, Processor, InstalledRAM, SystemType, Edition }) => {
        // let colors = ['#CEFA05'];
            ...
            <View style={{ backgroundColor: 'white', flex: 1 }}>
                <View
                    ...
                    <View style={{ flexDirection: 'row', justifyContent: 'space-between', width: '90%', alignItems: 'center' }}>
                        ...
                        <Text style={{ color: 'white', fontWeight: '600', fontSize: 20 }}>Template List</Text>
                ...
                >
                    <View style={{ height: "100%", alignItems: 'center', flexDirection: 'row', justifyContent: "center", position: 'absolute' }}>
                        <FlatList
                            data={slideData}
