...
const Home = ({ navigation, route }) => {
  ...
  const registerCustomer = () => {
    ...
    formDatas.append('Password', register.userPassword);
    formDatas.append('UserAddress', register.userAddress);
    formDatas.append('Phoneno', register.userPhoneno);
    formDatas.append('ProfilePhoto', {
      uri: singleFile.uri,
        ...
        >
          <View style={styles.modelview}>
            ...
            <TextInput
              ...
              placeholderTextColor="#2d333a"
              onChangeText={(userPassword) => setregister({ ...register, userPassword })}
              autoComplete={'off'}
            />
            <TextInput
              style={[styles.homeTextInput, { width: '90%', marginLeft: 5 }]}
